...
$lng['error']['nolanguageselect'] = 'Aucune langue choisie.';
...
$lng['error']['subdomainiswrong'] = 'Le sous-domaine "%s" contient des caractères invalides.';
...
$lng['serversettings']['vmail_uid']['description'] = 'Quels UID doivent avoir les e-mails ?';
$lng['serversettings']['vmail_gid']['title'] = 'GID des e-mails';
$lng['serversettings']['vmail_gid']['description'] = 'Quels GID doivent avoir les e-mails ?';
$lng['serversettings']['vmail_homedir']['title'] = 'Emplacement des e-mails';
$lng['serversettings']['vmail_homedir']['description'] = 'Dans quel dossier doivent être stockés les e-mails ?';
...
$lng['pwdreminder']['success'] = 'Demande de réinitialisation enregistrée.<br />Vous devriez recevoir un e-mail pour procéder à sa modification d\'ici quelques minutes.';
